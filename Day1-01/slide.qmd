...
Durig the next hour, you will be working with the `Swiss communes` data {{< fa database >}} collected from multiple public resources which are published by the Federal Statistical Office of Switzerland. 
