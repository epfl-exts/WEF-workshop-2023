...
Durig the next hour, you will be working with the `Swiss communes` data collected from multiple public resources published by the Federal Statistical Office of Switzerland. 
...
## {chalkboard-buttons="false" background-image="img/AdobeStock_318442666.jpeg"  background-size="cover"}
