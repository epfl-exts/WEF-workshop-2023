...
- Posteriors can turn out to be different for each version
:::
...
::: columns
::: {.column width="60%" }
This is where we need PyMC 🌱

It is a Python library for Bayesian statistical modeling, and we use it to do the Bayesian inference for the A/B testing problem.
