...
::: notes
let them run code in the notebook that does A/B testing with synthetic data based on frequentist approach, and say thaz they will learn bayesian approach tomorrow
::: -->