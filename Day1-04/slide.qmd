...
|:----------------:|:------------------:|:----------------:|:----------------:|
|           Frequentists            |                 \-                  |             observe $x$             |           learn about $\theta$           |
|           Bayesians            |          prior about $\theta$          |             observe $x$             |           learn about $\theta$           |
:::
...
::: 
::: {.column width="40%" }
![](img/AdobeStock_382722926.jpeg){width="55%" fig-align="left"}
:::
:::
...
- conversion: Conversion rate is the proportion of visitors that click on the button.
...
- posterior
- HDI
- underlying assumptions in AB testing

::: goal
how to do AB testing in a Bayesian way
:::
