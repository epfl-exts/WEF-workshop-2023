...
## {chalkboard-buttons="false" background-image="img/AdobeStock_316152114.jpeg" background-position="center"  background-repeat="no-repeat" background-opacity="0.5" background-size="cover"}

![](img/python-logo-inkscape.svg){width="30%" height="30%" fig-align="center"}
...
## {chalkboard-buttons="false" background-image="img/AdobeStock_561720123.jpeg"  background-size="100%, cover" background-position="center" background-opacity="0.5"}
