...
::: incremental
-   $\alpha=1$ and $\beta=1$ $\rightarrow$ uniform distribution

-   $\alpha=2$ and $\beta=2$ $\rightarrow$ symmetric distribution

-   $\alpha=2$ and $\beta=5$ $\rightarrow$ skewed distribution

-   $\alpha=5$ and $\beta=2$ $\rightarrow$ skewed distribution
:::
