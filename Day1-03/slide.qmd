...
likelihood vs probability distribution? let's go back to the coin example

- probability distribution: the probability of getting a head is 0.5
- likelihood: the probability of getting a head given that the coin is fair is 0.5
