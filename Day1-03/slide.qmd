...
In this case, the prior and posterior are in the same family of distributions, and we say that the prior is a conjugate prior to the likelihood function. Or both prior and posterior are conjugate distributions.
:::
...
-   You will be able to find the solution to the exercise in the `Day1-03/handson_solution.ipynb` notebook by the end of the day.
