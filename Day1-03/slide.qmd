...
> This is where [Bayesian Statistics]{style="background-color: yellow;"} steps in and provide answers
...
- They are based on Markov Chain Monte Carlo (MCMC) `sampling` methods
...
similar to beta distribution, gamma distribution is a convenient choice for the prior because it is a **conjugate prior** to the Poisson likelihood function.
