...
<br> Byes rule provides a simple passage from our [prior]{style="color: blue"} idea to [new insight]{style="background-color: #fadf43;"}
...
-   **New knowledge**: a speaker at the annual meeting will be from WEF NY office

-   What is my **posterior**? what is the probability that the speaker will be on time?
:::

<div style="position:relative; width:640px; height:480px; margin:0 auto;">
  <img class="fragment" src="img/bayes-example1.jpg"   style="position:absolute;top:0;left:0;" />
  <img class="fragment" src="img/bayes-example2.jpg" style="position:absolute;top:0;left:0;" />
  <img class="fragment" src="img/bayes-example3.jpg" style="position:absolute;top:0;left:0;" />
</div>
...
:::
::: {.column width="65%" }
![](img/bayes-example3.jpg){width="80%" height="80%" fig-align="right"}
:::
:::
...
[prior]{style="color:red"} ~ Beta distribution ➡️ [posterior]{style="color:#962cff"} ~ Beta distribution
:::
...
- Beta distributionf can become a symmetric distribution e.g. with $\alpha=\beta=4$
- Beta distribution can become a right (or left)-skewed e.g. with $\alpha=2$ (for $\beta=5$)
:::
